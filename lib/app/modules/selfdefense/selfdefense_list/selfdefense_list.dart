...
var selfDefenseCourseList = [
  CourseList(
    title: "Five Common Self Defense You Should Know!",
    imageList: "assets/images/list_five_common.png",
  ...
  CourseList(
    ...
    material: "Siapa sih yang mau hal buruk terjadi? Pasti nggak ada kan. Memang, kita tak bisa menebak apa yang akan terjadi pada diri kita, bahkan dalam satu detik kedepan. Lantas, apa yang bisa kita lakukan untuk mempersiapkan diri dari segala kemungkinan pelecehan seksual yang bisa terjadi? Kuy langsung saja dibaca!\n\n "
        ...
        "2. Berani speak-up dan tegas\n\n"
        "Pelaku pelecehan seksual biasanya menyasar korban yang terlihat lemah dan ciut. Ketika kita menunjukkan sikap tegas dan berani, secara tidak langsung kita pun sudah memotong niat jahat mereka dalam melakukan tindak kejahatan.\n\n"
        "3. Pintar sama-sama\n\n"
        "Kita mungkin sudah aware ya, tapi tidak menutup kemungkinan kalau orang-orang di sekitar kita masih clueless, takut, bahkan abai untuk tahu tentang penanggulangan pelecehan seksual ini. Padahal, semua orang berhak tahu bahwa tindak pelecehan seksual itu beragam dan pelakunya tak tertebak, bisa saja orang asing yang ketemu di jalan, bahkan keluarga atau kerabat dekat sekalipun. So, jangan ragu untuk berbagi ilmu, karena kita tak bisa menduga kapan ilmu tersebut bisa menyelamatkan mereka.\n\n"
        "4. Bantu mereka\n\n"
        "Tindakan dan dukungan bisa kita kerahkan untuk membantu mereka yang menjadi korban pelecehan. Dalam kondisi seperti ini, dukungan menjadi hal yang krusial bagi para korban, dan ada banyak bentuk dukungan yang bisa kita beri dalam proses penyembuhan fisik dan psikisnya. Pun bantuan yang berupa tindakan yaitu apabila melihat aksi pelecehan, kita tak boleh ragu untuk saling membela dan membantu.\n\n"
        "Nah, untuk informasi lebih, yuk tonton video seru di bawah ini:",
  ),
];